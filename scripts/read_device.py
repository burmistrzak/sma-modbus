...
LABELS: dict[DeviceType, dict[str, str]] = {
    ...
    DeviceType.SUNNY_TRIPOWER: {
        ...
        "grid_import_power": "Grid import power",
        "grid_export_power": "Grid export power",
        "dc_power_0": "DC power string 1",
        "dc_power_1": "DC power string 2",
        "dc_voltage_0": "DC voltage string 1",
        "dc_voltage_1": "DC voltage string 2",
        "dc_current_0": "DC current string 1",
        "dc_current_1": "DC current string 2",
        "dc_current_2": "DC current string 3",
        "dc_current_3": "DC current string 4",
        "insulation_resistance": "Insulation resistance",
        "insulation_residual_current": "Insulation residual current",
        "internal_temperature": "Internal temperature",
        "intermediate_circuit_voltage": "Intermediate circuit voltage",
    },
}
